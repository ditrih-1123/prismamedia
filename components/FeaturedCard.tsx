...
export function FeaturedCard({ article, href = "#" }: FeaturedCardProps) {
  ...
  return (
    <a
      href={href}
      className="group block rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2"
    ...
    >
      <article className="overflow-hidden rounded-lg">
        ...
        <div className="p-4 sm:p-6">
          ...
          <h2 className="mt-3 font-sans text-lg font-bold leading-snug text-zinc-900 group-hover:text-zinc-700 sm:text-xl">
            {article.title}
          </h2>
