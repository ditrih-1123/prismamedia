  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        <div className="overflow-hidden rounded-lg border border-zinc-100 px-4 py-5 sm:px-6 sm:py-6">
            ...
            {parties.map((party) => (
              <div key={party.name} className="flex items-center gap-3">
                <div className="flex w-36 shrink-0 items-center gap-2 sm:w-44">
                  ...
                  <span className="text-xs font-medium text-zinc-800">{party.name}</span>
                </div>
                ...
                <div className="w-12 shrink-0 text-right text-xs font-semibold text-zinc-900">
                  {party.value}%
                </div>
              </div>
            ))}
          ...
          <div className="mt-5 hidden border-t border-zinc-100 pt-4 text-[11px] text-zinc-500 sm:block">
            <p>
